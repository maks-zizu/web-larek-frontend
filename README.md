...
[Атрибуты](#атрибуты-10)  
[Методы](#методы-10)  
[Класс `Success`](#класс-success)  
[Атрибуты](#атрибуты-11)  
[Методы](#методы-11)  
[Класс `Modal`](#класс-modal)  
[Предназначение](#предназначение)  
[Функции](#функции-2)  
[Атрибуты](#атрибуты-12)  
[Методы](#методы-12)  
[Контроллеры (Presenter)](#контроллеры-presenter)  
[Класс `MainController`](#класс-maincontroller)  
[Атрибуты](#атрибуты-13)  
[Методы](#методы-13)  
[Обработка событий в `bindEvents()`](#обработка-событий-в-bindevents)  
